...
public class Driver {
	public static void main(String[] args) throws AlreadyExistsException, NullInputException, InvalidDataException {
		...
		/*
		 * try { //TEST SET 1, SIMPLE CREATIONS AND DELETIONS AND MODIFICATIONS
		 * 
		 * System.err.println(
		 * "____________________________________________________________________");
		 * System.err.println("*Deleteing HeLLoZZ INIT"); System.err.println("*" +
		 * Manager.Team.delete("HeLLoZZ")); System.err.println("*Deleteing Hello INIT");
		 * System.err.println("*" + Manager.Team.delete("Hello") + "\n");
		 * 
		 * System.err.println("*Creating Hello Team");
		 * System.err.println(Manager.Team.create("Hello")); System.err.println("-- " +
		 * Manager.Team.getName(Manager.Team.getId("Hello")) + " ----- " +
		 * Manager.Team.getId("Hello"));
		 * System.err.println("*Changing the team Name to HeLLoZZ");
		 * System.err.println(Manager.Team.update(Manager.Team.getId("Hello"),
		 * "HeLLoZZ"));
		 * 
		 * System.err.println(
		 * "____________________________________________________________________");
		 ...
		 * System.err.println("**Creating Problem Elvis"); System.err.println("**" +
		 * Manager.Problem.create("Elvis", problemDesc, problemTest));
		 * 
		 * System.err.println("**Changing problem Elvis"); System.err.println("**" +
		 * Manager.Problem.update(Manager.Problem.getId("Elvis"), "JohnnybCash",
		 * problemTest, problemDesc));
		 * 
		 * 
		 * System.err.println(
		 * "____________________________________________________________________");
		 ...
		 * System.err.println("*** CREATING MySol SOLUTION"); System.err.println("***" +
		 * Manager.Solution.create("MySol", Manager.Team.getId("HeLLoZZ"),
		 * Manager.Problem.getId("JohnnybCash"), "JAVA", solution));
		 * System.err.println("*** changing MySol"); Manager.Team.delete("temp team");
		 * Manager.Team.create("temp team"); System.err.println("***" +
		 * Manager.Solution.update(Manager.Solution.getId("MySol"), "YourSol",
		 * Manager.Team.getId("temp team") , Manager.Problem.getId("JohnnybCash"),
		 * "C++", 20, problemDesc));
		 * 
		 * 
		 * 
		 ...
		 * catch(DoesNotExistException e) { System.err.println(e.getMessage()); }
